...
export const templeConfig = {
  ...
  storyTitle: "關於保生宮的故事",
  storyContent: [
    "在新竹寶山的大崎村，保生宮守望這片土地已近兩個世紀。自清道光九年起，閩南與客家先民在此築廟奉祀保生大帝，廟埕成了村子的心臟：山歌在每個初二回響，收冬祭典與閹大雞比賽讓四季更迭有了熱鬧的秩序。保生宮承載的不只是信仰，更是彼此相認的方式與共享的記憶。",
    "時代向前，園區拓展。新竹科學園區的擴建為寶山帶來產業升級、就業機會與基礎建設的更新，讓在地與世界接軌。面對遷建的現實，我們選擇用科技與傳統並行──在保生大帝以擲筊允諾遷移後，啟動 3D 重建數位典藏計畫：在牆與瓦離開之前，把空間的神態與人情的溫度都留住。",
...
export const templeSceneFilter = (scenes) => {
